...
var _vueEasyLightbox = __webpack_require__(13);
...
exports.default = {
  components: { Lightbox: _vueEasyLightbox2.default },
  data: function data() {
    return {
      images: [],
      lightBoxData: [],
  ...
  methods: {
    ...
    chooseUploadFile: function chooseUploadFile(event) {
      ...
      (0, _index.fileToBase64)(file, function (base64) {
        _this3.images.push({
          source: file,
          path: base64,
          name: file.name
    ...
    checkMousePos: function checkMousePos(divId) {
      ...
      var _getElementPosition = (0, _index.getElementPosition)(div),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ea9cd346_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_app_vue__ = __webpack_require__(18);
...
/* scopeId */
var __vue_scopeId__ = "data-v-ea9cd346"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_app_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ea9cd346_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_app_vue__["a" /* default */],
...
var update = __webpack_require__(9)("562344aa", content, true, {});
...
// module
exports.push([module.i, ".drag-container[data-v-ea9cd346]{position:relative;height:160px;border:1px dashed #d6d6d6;border-radius:4px;background-color:#fff;text-align:center;cursor:pointer}.drag-container .image-icon-upload[data-v-ea9cd346]{margin:15px 0;height:50px;width:50px;vertical-align:middle}.drag-container .upload-text[data-v-ea9cd346]{color:#777;font-weight:400;line-height:1.5}.drag-container .upload-info-text[data-v-ea9cd346]{font-size:86%;color:#206ec5;text-decoration:none}.drag-container #fileInput[data-v-ea9cd346]{position:absolute;display:none;top:0;bottom:0;left:0;right:0}.image-list-container[data-v-ea9cd346]{display:flex;margin-top:10px;flex-wrap:wrap}.image-list-container .image-list-item[data-v-ea9cd346]{position:relative;padding:10px;border-radius:4px;border:1px solid #d6d6d6;margin-bottom:5px}.image-list-container .image-list-item[data-v-ea9cd346]:not(:last-child){margin-right:5px}.image-list-container .image-list-item .centered[data-v-ea9cd346]{left:50%;transform:translate(-50%,-50%);top:50%;position:absolute;display:block}.image-list-container .image-list-item .centered img[data-v-ea9cd346]{max-width:25px;max-height:17px;vertical-align:middle}.image-list-container .image-list-item .image-view-area[data-v-ea9cd346]{position:relative;height:32px;width:32px}.image-list-container .image-list-item .image-view-area .image-overlay[data-v-ea9cd346]{position:relative;width:100%;height:100%;background:rgba(0,0,0,.4);z-index:10;border-radius:5px;opacity:0;transition:all .3s ease-in-out 0s;text-align:center;cursor:pointer}.image-list-container .image-list-item .image-view-area .image-overlay[data-v-ea9cd346]:hover{opacity:1}.image-list-container .image-list-item .image-icon-zoom[data-v-ea9cd346]{width:20px;vertical-align:middle}.image-list-container .image-list-item .image-icon-delete[data-v-ea9cd346]{position:absolute;width:20px;height:20px;top:-5px;right:-5px;border-radius:50%;background:url(" + escape(__webpack_require__(8)) + ") no-repeat;background-size:cover;cursor:pointer}.image-list-container .image-list-item .image-icon-delete[data-v-ea9cd346]:hover{width:25px;height:25px;transition:all .3s linear 0s}", ""]);
...
module.exports = __webpack_require__.p + "delete.png?7844bf875caa2c0fa0c237e214aca927";
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0), __webpack_require__(15).setImmediate))
...
module.exports = __webpack_require__.p + "upload.png?887c4787fbe5a470001d1089f1db238e";
