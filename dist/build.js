...
"use strict";
throw new Error("Cannot find module \"@/utils/index\"");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_easy_lightbox__ = __webpack_require__(11);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: { Lightbox: __WEBPACK_IMPORTED_MODULE_1_vue_easy_lightbox__["a" /* default */] },
  data: function data() {
    return {
      images: [],
      lightBoxData: [],
  ...
  methods: {
    ...
    chooseUploadFile: function chooseUploadFile(event) {
      var _this3 = this;
      ...
      Object(__WEBPACK_IMPORTED_MODULE_0__utils_index__["fileToBase64"])(file, function (base64) {
        _this3.images.push({
          source: file,
          path: base64,
          name: file.name
        });
        _this3.lightBoxData.push(base64);
        // 移除文件，可以保证上传同样的文件时，也会触发change事件
        _this3.$refs.uploadFile.value = null;
      });
    },
    fileDragover: function fileDragover(event) {
    ...
    fileDrop: function fileDrop(event) {
      ...
      var file = files[0]; // 获取到第一个上传的文件对象
      if (!file) return;
      ...
      Object(__WEBPACK_IMPORTED_MODULE_0__utils_index__["fileToBase64"])(file, function (base64) {
        ...
        _this4.lightBoxData.push(base64);
        file.value = '';
      });
    },
    filePaste: function filePaste(event) {
      var _this5 = this;
      ...
      Object(__WEBPACK_IMPORTED_MODULE_0__utils_index__["fileToBase64"])(file, function (base64) {
        ...
        _this5.lightBoxData.push(base64);
      });
    },
    ...
    // 图片类型验证
    verificationFileType: function verificationFileType(filePath) {
    ...
    // 图片大小验证
    verificationFileSize: function verificationFileSize(fileSize) {
    ...
    showLightBox: function showLightBox(index) {
      this.index = index;
      this.visible = true;
    },
    ...
    checkMousePos: function checkMousePos(divId) {
      var div = document.getElementById(divId);

      var _getElementPosition = Object(__WEBPACK_IMPORTED_MODULE_0__utils_index__["getElementPosition"])(div),
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return __WEBPACK_IMPORTED_MODULE_0__app_vue__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05949002_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_app_vue__ = __webpack_require__(16);
...
/* scopeId */
var __vue_scopeId__ = "data-v-05949002"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_app_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05949002_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_app_vue__["a" /* default */],
...
var update = __webpack_require__(8)("43362328", content, true, {});
...
// module
exports.push([module.i, ".drag-container[data-v-05949002]{position:relative;height:160px;border:1px dashed #d6d6d6;border-radius:4px;background-color:#fff;text-align:center;cursor:pointer}.drag-container .image-icon-upload[data-v-05949002]{margin:15px 0;height:50px;width:50px;vertical-align:middle}.drag-container .upload-text[data-v-05949002]{color:#777;font-weight:400;line-height:1.5}.drag-container .upload-info-text[data-v-05949002]{font-size:86%;color:#206ec5;text-decoration:none}.drag-container #fileInput[data-v-05949002]{position:absolute;display:none;top:0;bottom:0;left:0;right:0}.image-list-container[data-v-05949002]{display:flex;margin-top:10px;flex-wrap:wrap}.image-list-container .image-list-item[data-v-05949002]{position:relative;padding:10px;border-radius:4px;border:1px solid #d6d6d6;margin-bottom:5px}.image-list-container .image-list-item[data-v-05949002]:not(:last-child){margin-right:5px}.image-list-container .image-list-item .centered[data-v-05949002]{left:50%;transform:translate(-50%,-50%);top:50%;position:absolute;display:block}.image-list-container .image-list-item .centered img[data-v-05949002]{max-width:25px;max-height:17px;vertical-align:middle}.image-list-container .image-list-item .image-view-area[data-v-05949002]{position:relative;height:32px;width:32px}.image-list-container .image-list-item .image-view-area .image-overlay[data-v-05949002]{position:relative;width:100%;height:100%;background:rgba(0,0,0,.4);z-index:10;border-radius:5px;opacity:0;transition:all .3s ease-in-out 0s;text-align:center;cursor:pointer}.image-list-container .image-list-item .image-view-area .image-overlay[data-v-05949002]:hover{opacity:1}.image-list-container .image-list-item .image-icon-delete[data-v-05949002]{position:absolute;width:20px;height:20px;top:-5px;right:-5px;border-radius:50%;background:url(" + escape(__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../assets/delete.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))) + ") no-repeat;background-size:cover;cursor:pointer}.image-list-container .image-list-item .image-icon-delete[data-v-05949002]:hover{width:25px;height:25px;transition:all .3s linear 0s}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"upload-image"}},[_c('div',{staticClass:"drag-container",attrs:{"id":"drag-container"},on:{"click":_vm.onclick,"dragover":_vm.fileDragover,"drop":_vm.fileDrop}},[_vm._m(0),_vm._v(" "),_c('label',{staticClass:"upload-text"},[_vm._v("在此区域点击、拖拽或粘贴上传图片")]),_vm._v(" "),_c('br'),_vm._v(" "),_c('span',{staticClass:"upload-info-text"},[_vm._v("粘贴时要求鼠标放置在此区域")]),_vm._v(" "),_c('input',{ref:"uploadFile",attrs:{"type":"file","id":"fileInput","accept":"image/png,image/jpg"},on:{"change":_vm.chooseUploadFile}})]),_vm._v(" "),_c('div',{staticClass:"image-list-container"},_vm._l((_vm.images),function(item,idx){return _c('div',{key:idx,staticClass:"image-list-item"},[_c('div',{staticClass:"image-view-area"},[_c('div',{staticClass:"image-overlay",on:{"click":function($event){return _vm.showLightBox(idx)}}},[_c('img',{attrs:{"src":__webpack_require__(17)}})]),_vm._v(" "),_c('div',{staticClass:"centered"},[_c('img',{attrs:{"src":item.path,"alt":item.name}})])]),_vm._v(" "),_c('div',{staticClass:"image-icon-delete",on:{"click":function($event){return _vm.deleteImage(idx)}}})])}),0),_vm._v(" "),_c('div',[_c('Lightbox',{attrs:{"visible":_vm.visible,"imgs":_vm.lightBoxData,"index":_vm.index},on:{"hide":_vm.handleHide}})],1)])}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('img',{staticClass:"image-icon-upload",attrs:{"src":__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./assets/upload.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))}})])}]
...
module.exports = __webpack_require__.p + "zoom.svg?ca0699bcbc3bc527483573ff5e62e165";
